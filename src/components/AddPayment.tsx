...
export default function AddPayment({params}:any) {
  ...
  return (
    <section className="container mx-auto px-3 lg:px-64 min-h-[80vh] flex flex-col  items-center gap-5 py-10">
      ...
      <div className="border rounded flex-col w-full">
        ...
        <p className="text-sm p-2 md:p-5">Add your withdrawal method to receive your remuneration directly to your bank account through PayPal.</p>
