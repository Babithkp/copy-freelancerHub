  ...
  return (
    <section className="flex-1 ">
      ...
      <div className="mt-10 space-x-4">
        <button className="px-3 border border-[#196EAF] hover:text-[#196EAF] hover:bg-transparent py-2 rounded bg-[#196EAF] duration-200 text-white font-semibold text-sm ">
          Publish
        </button>
        <button className="px-3 py-2 border rounded hover:text-white hover:bg-[#196EAF] border-[#196EAF] hover:scale-105 duration-200 text-[#196EAF] font-semibold text-sm ">
          Save
        </button>
      </div>
    </section>
